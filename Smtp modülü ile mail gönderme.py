...
try:
    mail = smtplib.SMTP("smtp.gmail.com",587) #hangi gmail severine baglanmak istedigimi ilk deger olarak veriyorum
#virgülden sonraki 587 yazan kısım ise serverin portunu belirtir
    ...
    mail.login("kullanıcı adınızı buraya giriniz","şifrenizi de bu kısıma")
